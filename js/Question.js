class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta: - Quem é o protagonista de Family Guy?" );
    this.question.position(150, 80);
    this.option1.html("1: Joe" );
    this.option1.position(150, 100);
    this.option2.html("2: Quagmire" );
    this.option2.position(150, 120);
    this.option3.html("3: Peter" );
    this.option3.position(150, 140);
    this.option4.html("4: Stewie" );
